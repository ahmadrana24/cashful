          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                ...
                decoration:
                    BoxDecoration(color: Colors.white, borderRadius: BorderRadius.vertical(top: Radius.circular(20.0))),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                            ...
                            InkWell(
                              onTap: () async {
                                BankDetail? result = await Navigator.push(
                                    context, MaterialPageRoute(builder: (context) => AddBankAccountScreen()));
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: Image(
                                            ...
                                            height: 40,
                                            fit: BoxFit.fitWidth,
                                            image: AssetImage('assets/images/std_bank.png'))),
                                    SizedBox(
                                      width: 10,
                                    ),
                                    Text(
                        ...
                        Text('Please ensure you only add a South African account that is in your own name',
                        ...
                        Consumer<UserViewModel>(
                          builder: (context, value, child) => AnimatedContainer(
                            ...
                            child: MaterialButton(
                                ...
                                onPressed: _paymentMethodAdded == null
                                    ? null
                                    : () async {
            ...
            child: ElevatedButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    paymentInfo = PaymentInfo(
                        mtnDetail: MtnDetail(accountNumber: mobileNumber.text, fullName: registeredNames.text));
